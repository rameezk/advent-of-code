...
# off x=-93533..-4276,y=-16170..68771,z=-104985..-24507""".splitlines()
    ...
    def intersect(c1, c2):
        x1_min, x1_max, y1_min, y1_max, z1_min, z1_max = c1
        x2_min, x2_max, y2_min, y2_max, z2_min, z2_max = c2
    ...
    def volume(c):
        x_min, x_max, y_min, y_max, z_min, z_max = c
    ...
    for line in data:
        ...
        for cuboid, sign in cuboids:
            ...
            if intersection:
                new_cuboids.append((intersection, -sign))

        if state == 'on':
            new_cuboids.append((new_cuboid, 1))

        cuboids.extend(new_cuboids)

    answer = sum(volume(c) * sign for c, sign in cuboids)
